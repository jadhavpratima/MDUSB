...
public class Free extends AppCompatActivity implements Animation.AnimationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhonePe.init(this);
        statusbtn = findViewById(R.id.freestatus);
        amount = findViewById(R.id.freeamount);
       // ml = findViewById(R.id.ml);
        cancel = findViewById(R.id.cancel);
        //name = findViewById(R.id.name);
        qr = findViewById(R.id.freeqr);
 ...
 /*       animMove = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.move);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Free.this);
    ...
    private void showDialogProductYellow() {
     ...
     /*   Button button = dialogsuccs.findViewById(R.id.okbtn);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                handler.removeCallbacks(runnable);
                Intent intent = new Intent(Free.this, TerminalActivity.class);
                startActivity(intent);
                dialogsuccs.dismiss();
